...
import com.tj.fragment.WarningDetailFragment;
...
public class HeadWarningActivity extends BaseActivity implements OnClickListener{
	...
	private void initViewPager() {
		if (getIntent().hasExtra("warnList")) {
			warnList.clear();
			warnList.addAll(getIntent().getExtras().<WarningDto>getParcelableArrayList("warnList"));
